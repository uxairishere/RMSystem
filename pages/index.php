    ...
    <div>
        <div class="home_page_wrapper" style="width: 95%; margin: 0 auto; padding: 0 0 5rem 0;">
                            ...
                            <div class="col-md-8">
                                ...
                                <form id="mainatt2" name="mainatt2" method="POST" action="addToCart.php">
                                    ...
                                    <div class="input-group incre-group">
                                        <button class="btn grad-btn-danger2 incre" type="button" id="decrement"><i class="bi bi-dash"></i></button>
                                        <input type="number" id="fperson" class="fperson" name="fperson" readonly>
                                        <button class="btn grad-btn-3 decre" type="button" id="increment"><i class="bi bi-plus"></i></button>
                                    </div>
            ...
            <?php if (isset($_SESSION['name'])) {  ?>
                <div class="text-center" style="padding: 1rem; background-color: black; border-radius: 12px; width: 80%; margin: 0 auto;">
