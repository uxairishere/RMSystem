...
<div class="container">
 ...
 <?php 
 echo $chef_id."<br>";
$q="INSERT INTO `msr`.`order` (`order_id`, `food_menu_id`, `food_quantity`, `user_id`, `order_date`,`order_status`,`rating_status`) VALUES (NULL, '$order', '$fperson', '$user_id', CURRENT_DATE(), 'In Process!',0)";
